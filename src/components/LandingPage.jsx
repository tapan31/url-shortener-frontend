    ...
    <div className="min-h-[calc(100vh-64px)]  lg:px-14 sm:px-8 px-4">
      <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
        <div className=" flex-1">
          ...
          <p className="text-slate-700 text-sm my-5">{desc}</p>
          <div className="flex items-center gap-3">
            <motion.button
              ...
              className="bg-custom-gradient cursor-pointer w-40 text-white rounded-md  py-2"
            >
              Manage Links
            </motion.button>
            <motion.button
              ...
              transition={{ duration: 0.8 }}
              onClick={dashBoardNavigateHandler}
              className="border-btnColor cursor-pointer border w-40 text-btnColor rounded-md  py-2 "
            >
              Create Short Link
            </motion.button>
          </div>
